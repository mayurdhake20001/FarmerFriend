package com.farmerfriend.Weather_Report.activities;
...
import com.farmerfriend.Weather_Report.AlarmReceiver;
import com.farmerfriend.Weather_Report.Constants;
import com.farmerfriend.R;
import com.farmerfriend.Weather_Report.adapters.ViewPagerAdapter;
import com.farmerfriend.Weather_Report.adapters.WeatherRecyclerAdapter;
import com.farmerfriend.Weather_Report.fragments.RecyclerViewFragment;
import com.farmerfriend.Weather_Report.models.Weather;
import com.farmerfriend.Weather_Report.tasks.GenericRequestTask;
import com.farmerfriend.Weather_Report.tasks.ParseResult;
import com.farmerfriend.Weather_Report.tasks.TaskOutput;
import com.farmerfriend.Weather_Report.utils.UnitConvertor;
import com.farmerfriend.Weather_Report.widgets.AbstractWidgetProvider;
import com.farmerfriend.Weather_Report.widgets.DashClockWeatherExtension;

public class MainActivity extends AppCompatActivity implements LocationListener {
    protected static final int MY_PERMISSIONS_ACCESS_FINE_LOCATION = 1;

    String speech[] = {"The Temperature is cool and it may rain. ", "Today\'s Temperature is below the normal temperature and it is advised to water your crops as usual. ", "Today temperature is normal and hence water your plants as usual. ", "The Temperature is hot and so water the crops properly without any delay. "};
    ...
    Typeface weatherFont, tamilFont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tamilFont = Typeface.createFromAsset(this.getAssets(), "fonts/TAMLKamban.ttf");
        todayIcon.setTypeface(weatherFont);
//        todayWind.setTypeface(tamilFont);
    ...
    private void aboutDialog() {
        ...
        String data = "";
        final int Temperature = (int) Float.parseFloat(Constants.CURRENT_TEMPERATURE);
        if(Temperature <= 25) {
            alert.setMessage(R.string.l25);
//            data = String.valueOf(R.string.l25);
            data = speech[0];
        }
        else if((Temperature > 25) && (Temperature <= 30)) {
            alert.setMessage(R.string.g25l30);
//            data = String.valueOf(R.string.g25l30);
            data = speech[1];
        }
        else if((Temperature > 30) && (Temperature <= 32)) {
//            data = String.valueOf(R.string.g30l32);
            alert.setMessage(R.string.g30l32);
            data = speech[2];
        }
        else if(Temperature > 32) {
//            data = String.valueOf(R.string.g32);
            alert.setMessage(R.string.g32);
            data = speech[3];
        }
...
//
//        System.out.println("===================Current Language: " + Locale.getDefault() + " =========================");
//
...
//                getBaseContext().getResources().getDisplayMetrics());
        ...
        System.out.println("===================Current Language: " + textToSpeech.getAvailableLanguages() + " =========================");
        ...
        com.farmerfriend.Weather_Report.Constants.CURRENT_TEMPERATURE = String.valueOf(temperature);
